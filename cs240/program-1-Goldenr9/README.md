...
DESIGN DESCRIPTION
Ants
	-I made a random number generator giving each ant a 50/50 chance
AntHill
	-I made a random number generator with a 1 in 5 chance of battle
	-I incremented though the list to check each ants placement while keeping track of how many ants were within 25ft of the hill. I then used a random nuber generator between 1 and the total number of ants to determine how many ants attacked. I then compared the numbers. I gave ties to the attackers.
Linked List:
	-I made a current Node pointer to handle iteration
	-I stored pointers instead of objects
